...
public class MedicationPlanEditJInternalFrame extends AbstractEditJInternalFrame<MedicationPlan> {
	...
	public MedicationPlanEditJInternalFrame(
		...
		super(desktopPane, "Medication Plan", toEdit, editDialogComponentFactory, observer, Map.of(
		MedicationPlanEditJPanel.MEDICATION_ITEM_PROVIDER_ID, medications, 
		MedicationPlanEditJPanel.MEDICATION_UNIT_ITEM_PROVIDER_ID, medicationUnits
		));
	}
