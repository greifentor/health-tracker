...
public class SymptomSelectJInternalFrame
	...
	@Override
	protected AbstractSelectPanel<Symptom> createSelectPanel() {
		return new SymptomSelectPanel(symptomService, CLASS_NAME, desktopPane, editDialogComponentFactory, this);
	}
}
