 ...
 */
@Generated
public class CommentTypeEditJPanel extends AbstractEditPanel<CommentType> {

	private JTextField textFieldName;

	public CommentTypeEditJPanel(CommentType toEdit, Map<String, ItemProvider<?>> itemProviders) {
	...
	@Override
	protected JPanel createComponentPanel(CommentType toEdit, Map<String, ItemProvider<?>> itemProviders) {
