...
public interface BodyTemperatureMeasurementDboMapper {
	BodyTemperatureMeasurement toModel(BodyTemperatureMeasurementDbo dbo);

	BodyTemperatureMeasurementDbo toDbo(BodyTemperatureMeasurement model);
}
