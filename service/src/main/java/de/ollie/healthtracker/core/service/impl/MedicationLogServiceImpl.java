...
class MedicationLogServiceImpl implements MedicationLogService {
	...
	@Override
	public MedicationLog createMedicationLog(boolean confirmed, Medication medication, MedicationUnit medicationUnit, LocalDate dateOfIntake, boolean selfMedication, LocalTime timeOfIntake, BigDecimal unitCount) {
		return medicationLogPersistencePort.create(confirmed, medication, medicationUnit, dateOfIntake, selfMedication, timeOfIntake, unitCount);
	}
