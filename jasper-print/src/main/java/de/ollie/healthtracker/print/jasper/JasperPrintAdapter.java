...
class JasperPrintAdapter implements PrintPort {
	...
	private HealthTrackingReportPO mapToPO(HealthTrackingReport report) {
		return new HealthTrackingReportPO()
			...
			.setBloodPressureMeasurements(bloodPressureMeasurementPOMapper.map(report.getBloodPressureMeasurements()))
			.setBloodPressureMeasurementsCumulated(
				bloodPressureMeasurementPOMapper.map(
